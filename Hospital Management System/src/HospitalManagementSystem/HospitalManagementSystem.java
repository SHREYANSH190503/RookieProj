...
public class HospitalManagementSystem {
    ...
    public static void bookAppointment(Patient patient,Doctor doctor,Connection connection,Scanner scanner){
        ...
        if (patient.getPatients(patientId) && doctor.getDoctor(doctorId)){
    ...
    public static boolean checkDoctorAvailaibility(int doctorId,String appointmentDate , Connection connection){
